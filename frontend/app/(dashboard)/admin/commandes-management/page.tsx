...
export default function CommandeManagemnt() {
  const { getAllCommandes, isLoading, error, commandes } = useCommandeStore();
  ...
  const filteredCommandes = useMemo(() => {
    ...
    // Filter by search term (restaurant name or client name)
    if (searchTerm) {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Tous les Commandes</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="relative">
          ...
          <Input
            placeholder="Rechercher un restaurant ou client..."
            className="pl-10"
            value={searchTerm}
      ...
      {filteredCommandes.length === 0 ? (
        ...
        <Tabs defaultValue="all" className="w-full">
          <TabsList className="grid grid-cols-3 my-12 md:grid-cols-7 mb-8">
          ...
          <TabsContent
            value="all"
            className="grid mt-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
          >
