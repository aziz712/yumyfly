  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="grid grid-cols-1 gap-8 w-full">
        <ProfileCard user={ownerProfile.user} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-700">
                      {ownerProfile.user.prenom || "Non renseigné"}
                    </p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium mb-1">Nom</h3>
                    <p className="text-gray-700">
                      {ownerProfile.user.nom || "Non renseigné"}
                    </p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium mb-1">Email</h3>
                    <p className="text-gray-700">{ownerProfile.user.email}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium mb-1">Téléphone</h3>
                    <p className="text-gray-700">
                      {ownerProfile.user.telephone || "Non renseigné"}
                    </p>
                  </div>
                </div>
                <div className="pt-4">
                  <UpdateProfileModal
                    ...
                    onProfileUpdated={() => getOwnerProfile}
                  />
                </div>
              </CardContent>
            </Card>
