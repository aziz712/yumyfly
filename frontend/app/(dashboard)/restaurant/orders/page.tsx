...
export default function OrdersRestaurantManagemnts() {
  const { getAllRestaurantCommandes, isLoading, error, commandes } =
    useCommandeStore();
    ...
    return (
      <div className="flex justify-center items-center min-h-[60vh]">
        <div className="text-red-500 text-center">
          ...
          <p>{error}</p>
          <Button
            onClick={() => getAllRestaurantCommandes()}
            className="mt-4"
            variant="outline"
          >
            Réessayer
